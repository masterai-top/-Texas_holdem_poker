#ifndef __SYSTEM_INFO_CONFIG_DELETE_H__
#define __SYSTEM_INFO_CONFIG_DELETE_H__
class SystemInfoConfigDeleteRequest
{
public:
	SystemInfoConfigDeleteRequest(const string& json) {
...
class SystemInfoConfigDeleteResponse
{
public:
	SystemInfoConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
